...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS-->
    <link href="script/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template-->
    <link href="script/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">

    <!-- Page level plugin CSS-->
    <link href="script/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
...
?>
    ...
    <script src="script/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="script/vendor/jquery-easing/jquery.easing.min.js"></script>
